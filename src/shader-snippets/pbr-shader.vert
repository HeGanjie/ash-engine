...
in vec3 a_normal;
in vec3 a_tangent;
in vec2 a_albedo_texcoord;
in vec2 a_normal_texcoord;
in vec2 a_metallic_texcoord;
in vec2 a_roughness_texcoord;
in vec2 a_ambientOcclusion_texcoord;
...
out mat3 v_TBN;
out vec2 v_albedo_texcoord;
out vec2 v_normal_texcoord;
out vec2 v_metallic_texcoord;
out vec2 v_roughness_texcoord;
out vec2 v_ambientOcclusion_texcoord;
...
void main() {
    ...
    v_albedo_texcoord = a_albedo_texcoord;
    v_normal_texcoord = a_normal_texcoord;
    v_metallic_texcoord = a_metallic_texcoord;
    v_roughness_texcoord = a_roughness_texcoord;
    v_ambientOcclusion_texcoord = a_ambientOcclusion_texcoord;
